...
#orange headlines
styleHeadlines = "color: rgb(242, 141, 27);\nfont: bold 24pt \"MS Shell Dlg 2\";"
# Black background
styleBackground = "background-color: rgb(0, 0, 0)"
# Text under headline or similar short text
styleText1="color: rgb(255, 255, 255);\nfont: 75 18pt \"MS Shell Dlg 2\";"
#big blue buttons
styleBluebuttonbig1= "QPushButton{\n""    font: 75 26pt \"MS Shell Dlg 2\" ;\n""    background-color: #1C4481;\n""    border-radius: 5px;\n""    color:white;\n""    text-align:bottom;\n""    background-origin: padding;\n""   background-clip: padding;\n""    padding: 30px;\n""    background-image: url(:/icons/icon_plus);\n""  background-position: top\n;""     background-repeat: no-repeat}\n""\n""QPushButton:hover{\n""    border: 2px solid rgb(255, 255, 255)\n""}"
styleBluebuttonbig2= "QPushButton{\n""    font: 75 26pt \"MS Shell Dlg 2\" ;\n""    background-color: #1C4481;\n""    border-radius: 5px;\n""    color:white;\n""    text-align:bottom;\n""    background-origin: padding;\n""   background-clip: padding;\n""    padding: 30px;\n""    background-image: url(:/icons/demo);\n""  background-position: top\n;""     background-repeat: no-repeat}\n""\n""QPushButton:hover{\n""    border: 2px solid rgb(255, 255, 255)\n""}"
styleBluebuttonbig3= "QPushButton{\n""    font: 75 26pt \"MS Shell Dlg 2\" ;\n""    background-color: #1C4481;\n""    border-radius: 5px;\n""    color:white;\n""    text-align:bottom;\n""    background-origin: content;\n""   background-clip: padding;\n""    padding: 30px;\n""    background-image: url(:/icons/demo_sonne);\n""  background-position: top\n;""     background-repeat: no-repeat}\n""\n""QPushButton:hover{\n""    border: 2px solid rgb(255, 255, 255)\n""}"
styleBluebuttonbig4= "QPushButton{\n""    font: 75 26pt \"MS Shell Dlg 2\" ;\n""    background-color: #1C4481;\n""    border-radius: 5px;\n""    color:white;\n""    text-align:bottom;\n""    background-origin: content;\n""   background-clip: padding;\n""    padding: 30px;\n""    background-image: url(:/icons/demo_regen);\n""  background-position: top\n;""     background-repeat: no-repeat}\n""\n""QPushButton:hover{\n""    border: 2px solid rgb(255, 255, 255)\n""}"
